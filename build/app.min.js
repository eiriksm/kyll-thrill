...
"use strict";var m=require("mithril"),c=document.getElementById("content"),list={controller:function(){if(window&&window.localStorage&&window.localStorage.getItem("redirect")){var t=window.localStorage.getItem("redirect");window.localStorage.clear("redirect"),setTimeout(function(){m.route(t)},10)}this.list=[];for(var e=0;e<appUrls.length;e++)this.list.push(appUrls[e])},view:function(t){return m("div.content",[t.list.map(function(t){return m("div.post",[m('a[href="'+baseUrl+t.url+'"].postlink',{config:m.route},[m("span.date",t.date+":"),m("h2",[m("span.title",t.title)])])])})])}},post={controller:function(){this.year=m.route.param("year"),this.month=m.route.param("month"),this.day=m.route.param("day"),this.file=m.route.param("file"),this.text="";var t=this;m.request({method:"GET",url:baseUrl+"/blog/"+this.year+"/"+this.month+"/"+this.day+"/"+this.file+"/index.html",deserialize:function(t){return t}}).then(function(e){t.text=e})},view:function(t){if("undefined"!=typeof disqus_shortname){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="//"+disqus_shortname+".disqus.com/embed.js",document.getElementsByTagName("head")[0].appendChild(e)}return m("div.content",[m("div.post-full",m.trust(t.text))])}};m.route.mode="pathname";var routeConf={};routeConf["/"]=list,routeConf[baseUrl+"/"]=list,routeConf["/blog/:year/:month/:day/:file"]=post,routeConf["/blog/:year/:month/:day/:file/"]=post,routeConf[baseUrl+"/blog/:year/:month/:day/:file"]=post,routeConf[baseUrl+"/blog/:year/:month/:day/:file/"]=post,m.route(c,baseUrl+"/",routeConf);var body=document.body,html=document.documentElement,height=Math.max(body.scrollHeight,body.offsetHeight,html.clientHeight,html.scrollHeight,html.offsetHeight),onScrollFunction=function(){height=Math.max(body.scrollHeight,body.offsetHeight,html.clientHeight,html.scrollHeight,html.offsetHeight);var t=window.scrollY,e=document.getElementsByClassName("site-title")[0],o=window.innerHeight/6;e.style.opacity=1-t/o,t>=height-window.innerHeight-100&&document.getElementsByTagName("footer")[0].setAttribute("style","opacity: "+(1+(t-(height-window.innerHeight))/100))};window.onscroll=onScrollFunction;
