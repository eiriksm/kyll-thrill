...
var c=document.getElementById("content"),list={controller:function(){if(window&&window.localStorage&&window.localStorage.getItem("redirect")){var t=window.localStorage.getItem("redirect");window.localStorage.clear("redirect"),setTimeout(function(){m.route(t)},10)}this.list=[];for(var e=0;e<appUrls.length;e++)this.list.push(appUrls[e])},view:function(t){return m("div.content",[t.list.map(function(t){return m("div.post",[m("h3",[m('a[href="'+baseUrl+t.url+'"].postlink',{config:m.route},[m("span.date",t.date+" - "),m("span.title",t.title)])])])})])}},post={controller:function(){this.year=m.route.param("year"),this.month=m.route.param("month"),this.day=m.route.param("day"),this.file=m.route.param("file"),this.text="";var t=this;m.request({method:"GET",url:"blog/"+this.year+"/"+this.month+"/"+this.day+"/"+this.file+"/index.html",deserialize:function(t){return t}}).then(function(e){t.text=e})},view:function(t){return m("div.content",[m("div.post-full",m.trust(t.text))])}};m.route.mode="pathname";var routeConf={};baseUrl&&""!==baseUrl||(baseUrl="/"),routeConf["/"]=list,routeConf[baseUrl]=list,routeConf["/blog/:year/:month/:day/:file"]=post,routeConf["/blog/:year/:month/:day/:file/"]=post,routeConf[baseUrl+"/blog/:year/:month/:day/:file"]=post,routeConf[baseUrl+"/blog/:year/:month/:day/:file/"]=post,m.route(c,baseUrl,routeConf);