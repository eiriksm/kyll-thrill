...
var c=document.getElementById("content"),list={controller:function(){this.list=[];for(var t=0;t<appUrls.length;t++)this.list.push(appUrls[t])},view:function(t){return m("div.content",[t.list.map(function(t){return m("div.post",[m("h3",[m('a[href="'+t.url+'"].postlink',{config:m.route},[m("span.date",t.date+" - "),m("span.title",t.title)])])])})])}},post={controller:function(){this.year=m.route.param("year"),this.month=m.route.param("month"),this.day=m.route.param("day"),this.file=m.route.param("file"),this.text="";var t=this;m.request({method:"GET",url:"/blog/"+this.year+"/"+this.month+"/"+this.day+"/"+this.file+"/index.html",deserialize:function(t){return t}}).then(function(e){t.text=e})},view:function(t){return m("div.content",[m("div.post-full",m.trust(t.text))])}};m.route.mode="hash",m.route(c,"/home",{"/home":list,"/blog/:year/:month/:day/:file":post});