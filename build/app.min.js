...
function init(t){"use strict";var e=t.appUrls;t.c=document.getElementById("content");var i={controller:function(){if(t&&t.localStorage&&t.localStorage.getItem("redirect")){var i=t.localStorage.getItem("redirect");t.localStorage.clear("redirect"),setTimeout(function(){m.route(i)},10)}this.list=[];for(var r=0;r<e.length;r++)this.list.push(e[r]);this.navigate=function(t){var e=t.getAttribute("href");m.route(e,{},!0)}},view:function(e){return m("div.content",[e.list.map(function(i){return m("div.post",[m('a[href="'+t.baseUrl+i.url+'"].postlink',{onclick:function(){return e.navigate(this),!1}},[m("span.date",i.date+":"),m("h2",[m("span.title",i.title)])])])})])}},r={controller:function(){this.year=m.route.param("year"),this.month=m.route.param("month"),this.day=m.route.param("day"),this.file=m.route.param("file"),this.text="";var e=this;m.request({method:"GET",url:t.baseUrl+"/blog/"+this.year+"/"+this.month+"/"+this.day+"/"+this.file+"/index.html",deserialize:function(t){return t}}).then(function(t){e.text=t})},view:function(e){if("undefined"!=typeof t.disqus_shortname){var i=document.createElement("script");i.type="text/javascript",i.async=!0,i.src="//"+t.disqus_shortname+".disqus.com/embed.js",document.getElementsByTagName("head")[0].appendChild(i)}return m("div.content",[m("div.post-full",m.trust(e.text))])}};m.route.mode="pathname";var n={};n["/"]=i,n[t.baseUrl+"/"]=i,n["/blog/:year/:month/:day/:file"]=r,n["/blog/:year/:month/:day/:file/"]=r,n[t.baseUrl+"/blog/:year/:month/:day/:file"]=r,n[t.baseUrl+"/blog/:year/:month/:day/:file/"]=r,m.route(t.c,t.baseUrl+"/",n);var o=document.body,a=document.documentElement,l=Math.max(o.scrollHeight,o.offsetHeight,a.clientHeight,a.scrollHeight,a.offsetHeight),s=function(){l=Math.max(o.scrollHeight,o.offsetHeight,a.clientHeight,a.scrollHeight,a.offsetHeight);var e=t.scrollY,i=document.getElementsByClassName("site-title")[0],r=t.innerHeight/6;i.style.opacity=1-e/r,e>=l-t.innerHeight-100&&document.getElementsByTagName("footer")[0].setAttribute("style","opacity: "+(1+(e-(l-t.innerHeight))/100))};t.onscroll=s,t.m=m}var m=require("mithril");module.exports=init;
